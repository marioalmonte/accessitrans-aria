...
El plugin incluye soporte para internacionalización, preparándolo para su traducción a múltiples idiomas. Los archivos de traducción deben colocarse en el directorio `/languages`.
